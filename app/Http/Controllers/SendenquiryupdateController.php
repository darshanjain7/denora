   ...
   date_default_timezone_set('Asia/Kolkata'); 
     ...
     $fileNamewithext = preg_replace('/\s+/', '_', $fileNamewithext1); 
       ...
       $sknum= $data['sknumber'];
        ...
        $values = array('name' => $request->input('name'),'email' => $request->input('email'),'mobile' => $request->input('mobile'),'subject' => $request->input('subject'),'site_name' => $request->input('sitename'),'sk_number' => $sknum,'note' => $request->input('msg'),'created_date' => $curr_date,'created_ip' => $ip,'doc_upload' => $fileNameToUpload);
