               ...
               <div class="container-fluid">
                ...
                <form action="}" method="post"  enctype="multipart/form-data">
                           ...
                           @method('put')
                            ...
                            <tr>  <th style="width: 45%;padding: 13px;">Name:</th><td style="padding-left: 13px;" >{{$tbl_contents->name}}</td></tr>
                            <tr>  <th style="width: 45%;padding: 13px;">Email ID:</th><td style="padding-left: 13px;" >{{$tbl_contents->email}}</td></tr>
                            <tr>  <th style="width: 45%;padding: 13px;">Mobile:</th><td style="padding-left: 13px;" >{{$tbl_contents->mobile}}</td></tr>
                            ...
                            <tr>  <th style="width: 45%;padding: 13px;">Part No:</th><td style="padding-left: 13px;" >{{$tbl_contents->part_no}}</td></tr>
                            ...
                            <tr>  <th style="width: 45%;padding: 13px;">Browser, Version & Platform:</th><td style="padding-left: 13px;" >{{$tbl_contents->browser}}</td></tr>
