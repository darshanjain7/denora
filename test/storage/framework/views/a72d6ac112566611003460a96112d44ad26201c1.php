...
<?php endif; ?>
                ...
                <form action="<?php echo e(action('SknumberdatasheetController@store')); ?>" method="post"  enctype="multipart/form-data">
                                 <?php echo csrf_field(); ?>
                                       ...
                                       <div class="col-md-2">Data Sheet Name:</div><div class="col-md-10"><input type="text" class="form-control" placeholder="Data Sheet Name" name="dname" rows="4" required="">
                                       <br></div>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gaschlorinationd/public_html/test/resources/views/admingo/createdatasheet.blade.php ENDPATH**/ ?>