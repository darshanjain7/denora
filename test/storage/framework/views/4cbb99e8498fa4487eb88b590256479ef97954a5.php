...
<div class="main">
           <div class="main-content">
               <div class="container-fluid">
                ...
                <form action="../../sknumberdrowing/<?php echo e($tbl_contents->product_drowing_id); ?>" method="post"  enctype="multipart/form-data">
                                 <?php echo csrf_field(); ?>
                           <?php echo method_field('put'); ?>
                            ...
                            <div class="col-md-2">Product SK Number:</div><div class="col-md-10"><select   class="form-control" name="sknumber">
                                       ...
                                       <div class="col-md-2">Drawing Name:</div><div class="col-md-10"><input class="form-control" name="drowingname" placeholder="Drawing Name" type="text" required="" value=" <?php echo e($tbl_contents->drowing_name); ?>">
                                       <br></div>
                                        
                                    
                                      <div class="col-md-2"><br>PDF Upload:</div><div class="col-md-10"> 
                                       <br><input type="file" class="form-control" name="upload" placeholder="Upload Document" value="<?php echo e($tbl_contents->drowing_pdf); ?>">
                                </div>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gaschlorinationd/public_html/test/resources/views/admingo/editsknumberdrowing.blade.php ENDPATH**/ ?>