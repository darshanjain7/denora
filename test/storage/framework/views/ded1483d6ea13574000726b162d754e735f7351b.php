                ...
                <form action="../../sknumberdatasheet/<?php echo e($tbl_contents->product_o_m_id); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <?php echo method_field('put'); ?>
                            ...
                            <div class="col-md-2">Product SK Number:</div><div class="col-md-10"><select   class="form-control" name="sknumber">
                                       ...
                                       <div class="col-md-2">Data Sheet Name:</div><div class="col-md-10"><input class="form-control" name="drowingname" placeholder="Data Sheet Name" type="text" required="" value=" <?php echo e($tbl_contents->o_m_name); ?>">
                                       <br></div>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gaschlorinationd/public_html/test/resources/views/admingo/editsknumberdatasheet.blade.php ENDPATH**/ ?>