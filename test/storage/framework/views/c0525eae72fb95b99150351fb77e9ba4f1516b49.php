               ...
               <div class="container-fluid">
                ...
                <form action="}" method="post"  enctype="multipart/form-data">
                           ...
                           <?php echo method_field('put'); ?>
                            ...
                            <tr>  <th style="padding: 13px;">Name:</th><td style="padding-left: 13px;" ><?php echo e($tbl_contents->name); ?></td></tr>
                            <tr>  <th style="padding: 13px;">Email ID:</th><td style="padding-left: 13px;" ><?php echo e($tbl_contents->email); ?></td></tr>
                            <tr>  <th style="padding: 13px;">Mobile:</th><td style="padding-left: 13px;" ><?php echo e($tbl_contents->mobile); ?></td></tr>
                            <tr>  <th style="width: 45%;padding: 13px;">SK Number:</th><td style="padding-left: 13px;" ><?php echo e($tbl_contents->sk_number); ?></td></tr>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gaschlorinationd/public_html/test/resources/views/admingo/viewenquirydetails.blade.php ENDPATH**/ ?>