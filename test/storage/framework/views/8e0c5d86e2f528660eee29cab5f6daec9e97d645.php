...
<?php endif; ?>
                               <div class="panel-heading">
                                     <h3  style="    color: #2b333e; font-weight: 600;">Upload SK Number's Drowing</h3>
                               </div>
                               <div class="panel-body">
                <form action="<?php echo e(action('DrowingController@store')); ?>" method="post"  enctype="multipart/form-data">
                                 <?php echo csrf_field(); ?>
                                       ...
                                       <div class="col-md-2">Drowing Name:</div><div class="col-md-10"><input type="text" class="form-control" placeholder="Drowing Name" name="dname" rows="4" required="">
                                       <br></div>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\gaschlorination\resources\views/admingo/createdrowing.blade.php ENDPATH**/ ?>