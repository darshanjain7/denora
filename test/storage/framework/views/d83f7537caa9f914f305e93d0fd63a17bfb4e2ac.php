			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages4" data-toggle="collapse" class="collapsed <?php echo e(Str::startsWith(Route::currentRouteName(), 'sknumberdatasheet') ? 'active' : ''); ?>"><i class="lnr lnr-enter"></i> <span>Product O M Manual</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
...
<?php /**PATH D:\xampp\htdocs\gaschlorination\resources\views/theme/menu.blade.php ENDPATH**/ ?>