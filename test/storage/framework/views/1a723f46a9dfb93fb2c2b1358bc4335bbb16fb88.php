...
<?php endif; ?>
				 ...
				 <form action="<?php echo e(action('ProducttypeController@store')); ?>" method="post"  enctype="multipart/form-data">
  								<?php echo csrf_field(); ?>

  								

											<div class="col-md-2">Group Group Name:</div><div class="col-md-10"><select class="form-control" name="grpname">
												...
												<option value="<?php echo e($tbl_contents->product_group_id); ?> "><?php echo e($tbl_contents->group_name); ?> </option>
...
<?php echo $__env->make('inc.adminlayout123', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\gaschlorination\resources\views/admingo/producttype.blade.php ENDPATH**/ ?>