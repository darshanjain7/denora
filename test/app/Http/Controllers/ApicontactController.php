    ...
    public function listdb(Request $request)
     ...
     $data= array('name' => $request->name,
        ...
        if($image_is==NULL)
        {
         ...
         $values = array('name' => $request->input('name'),'email' => $request->input('email'),'mobile' => $request->input('mobile'),'subject' => $request->input('subject'),'site_name' => $request->input('sitename'),'part_no' => $request->input('partslno'),'note' => $request->input('msg'),'created_date' => $curr_date,'created_ip' => $ip,'browser' => $browser,'doc_upload' => $no_image_name_db);
        ...
        $values = array('name' => $request->input('name'),'email' => $request->input('email'),'mobile' => $request->input('mobile'),'subject' => $request->input('subject'),'site_name' => $request->input('sitename'),'part_no' => $request->input('partslno'),'note' => $request->input('msg'),'created_date' => $curr_date,'created_ip' => $ip,'browser' => $browser,'doc_upload' => $image_name_db);
        DB::table('tbl_customer_contactus')->insert($values);
    ...
    public function sknumber(Request $request)
     {
       ...
       $values = array('name' => $request->input('name'),'email' => $request->input('email'),'mobile' => $request->input('mobile'),'subject' => $request->input('subject'),'site_name' => $request->input('sitename'),'sk_number' => $sknum,'note' => $request->input('msg'),'created_date' => $curr_date,'created_ip' => $ip,'system_details' => $browser,'doc_upload' => $image_name_db);
              DB::table('tbl_customer_sk_number_request')->insert($values);
         $data_mail= array('name' => $request->name,
        'email' => $request->email,
        'subject' => $request->subject,
