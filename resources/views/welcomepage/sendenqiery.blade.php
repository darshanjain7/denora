...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
 <form action="{{ action('SendenquiryupdateController@store')}}" method="post" enctype="multipart/form-data"   >
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="background: #f2f2f2; margin-bottom:30px; box-shadow:0px 0 22px #6060604d;">  <br>
            ...
            <div class="col-md-12">
            	<input class="form-control" name="email" placeholder="Your Email ID" type="email" value="{{ old('email') }}"  required=""> 	<br>
            </div>
            <div class="col-md-12">
            	<input class="form-control"  name="mobile" placeholder="Your Mobile Number" value="{{ old('mobile') }}"  type="text" required="" >
                <br>
            </div>
               <div class="col-md-12">
            	<input class="form-control"  name="sknumber" placeholder="SK Number" value="{{ $id }}" type="text" required="" readonly>
                <br>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <input class="form-control" name="sitename" placeholder="Site Name" value="{{ old('sitename') }}" type="text" >
                <br>
            </div>
               <div class="col-md-12">
